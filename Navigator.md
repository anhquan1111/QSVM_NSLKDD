...
- ⏭️ **1.7 NEXT (OPTIONAL)** — UNSW C5 calibration multirun. Mục tiêu: surface lợi thế QSVM trên metric KHÁC F1 (ECE rare, AUC-PR rare, Cohen's d margin) tương tự NSL-KDD 1.2. Nếu chạy → có 1 góc data point bổ sung; nếu bỏ → Phase 1 đóng tại đây
