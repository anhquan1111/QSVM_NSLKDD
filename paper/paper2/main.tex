...
dominant, which we report transparently, and we show that Platt scaling
is the right recalibration tool for margin-based quantum and SVM models
but counterproductive for tree ensembles. For deployments where
trustworthy alerts on scarce, dangerous classes are the priority, the
quantum kernel adds measurable value despite its accuracy trade-off.
