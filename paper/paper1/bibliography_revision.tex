...
%
% CAN QUYET DINH: bai trich [26] o muc II-D voi vai tro 'survey ve
% huong tiep can luong tu cho an ninh mang'. Can mot survey CO THAT
% thay vao, hoac viet lai cau do de khong can trich. Ung vien thay
% duoc khi tim (PHAI kiem lai truoc khi dung):
%   - Quantum Machine Learning for Cybersecurity: A Taxonomy and
%     Future Directions, arXiv:2512.15286
%   - Enhancing Network Intrusion Detection with Quantum Machine
%     Learning: A Comprehensive Survey, Future Internet 18(5), 234
% --------------------------------------------------------------
...
\bibitem{qmi2026}
``Benchmarking quantum machine learning methods for intrusion detection on
noisy quantum computers,'' \emph{Quantum Mach. Intell.}, 2026,
doi: 10.1007/s42484-026-00379-4.
% CAN BO SUNG: danh sach tac gia va so trang. Springer chan toan van; tim
% hai lan (Springer + ResearchGate) deu khong lay duoc trang tac gia.
% KHONG duoc doan ten -- doi ban day du tu thu vien truong roi dien vao.
