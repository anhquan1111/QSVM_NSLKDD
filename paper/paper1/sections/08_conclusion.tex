...
The structure has three parts. The ordering between \QSVM{} and every strong
classical baseline reverses between $N=2000$ and $N=5000$ under the natural class
prior, in both tuning arms, and disappears when rare attacks are enriched. A
...
favours the classical model, with off-diagonal Gram dispersion decaying about
twice as fast for the \ZZ{} map as for its entanglement-free control and
tracking macro-$F_1$ at $r=+0.77$.
