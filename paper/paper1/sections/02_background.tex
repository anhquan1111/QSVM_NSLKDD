...
\revnote{rewrite}{Ban da nop: Definition 1--2 + Proposition 1--2. Gop lai, Prop 1 ha xuong fact (F1) theo yeu cau R3-3.}
...
\revnote{rewrite}{Them survey 2026 va bai Cirillo et al. (QMI 2026) -- bai Reviewer 1 chi dich danh o y R1-1.}
...
\revnote{new}{Muc moi. Hai bai Reviewer 3 dan lam bang chung ``ket qua da co san'' (y R3-5). Da doc toan van ca hai.}
...
\revnote{new}{Muc moi. Bai Carducci ICAD 2026 -- Reviewer 4 chi dich danh o y R4-1.}
...
\revnote{rewrite}{Bang I dung lai han: 4 bai/3 cot -> 5 bai/13 dong, moi o doc tu toan van.}
