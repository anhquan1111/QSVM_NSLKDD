...
baseline, and sixty-eight are inconclusive.
...
\revnote{rewrite}{Ban da nop co 9 hang trong forest plot; nay 110 o, moi o deu co du $\Delta$/CI/$p$/$d_z$.}
...
\revnote{rewrite}{Reviewer 2 chi ra o y R2-4 rang ban cu cho che do duong du thong ke con che do am chi noi dinh tinh. Nay hai ben ngang nhau.}
...
\revnote{new}{Muc moi -- gop ca ``decision rule'' cua ban cu vao day.}
