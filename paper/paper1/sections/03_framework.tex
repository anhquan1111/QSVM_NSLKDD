...
\revnote{rewrite}{Ban da nop chi co Eq. (5). Nay viet tuong minh Eq. (1)--(4).}
...
\revnote{rewrite}{Problem 1 yeu di co y: chap nhan cau tra loi AM la ket qua.}
...
\subsection{Pipeline}
\revnote{rewrite}{Ban da nop co Fig. 2, Fig. 3 va Table II cho muc nay; ca ba da bo, mo ta bang chu.}
...
\revnote{keep}{Giu nguyen y cua ban da nop.}
