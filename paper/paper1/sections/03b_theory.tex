...
\revnote{rewrite}{Proposition 1, 3, 4 kem chung minh -> ha xuong fact (F1)(F2)(F3), chi trich dan. Theo yeu cau R3-3 va R4-4.}
...
\revnote{fix}{THAY HAN. Ban da nop dung Eq. (6) J(n) + Definition 4 (Pareto) + Algorithm 1 + Theorem 1. Reviewer 4 chi ra Theorem 1 SAI va buoc Pareto khong loc duoc ung vien nao. Thay bang luat ba giai doan tu vung, khong trong so.}
...
\revnote{fix}{Ban da nop dung Proposition 4 + kiem dinh z hai mau, coi hai nhanh la doc lap trong khi chung dung chung tap train. Thay bang giao thuc ghep cap trong tung run + hieu chinh Holm.}
...
\label{sec:erratum}
\revnote{new}{MUC MOI -- tu khai 4 loi cua ban da nop. Hai loi do Reviewer 4 chi ra; hai loi con lai KHONG reviewer nao bat, nhom tu tim ra.}
