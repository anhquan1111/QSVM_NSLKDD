...
\textbf{Bibliography.} Six entries added, one removed, one corrected. The
removal and the correction are both changes Reviewer~2 asked for. Every
bibliography change is itemised in a dedicated section of the response letter,
as TETC requires.
